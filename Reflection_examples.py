FEW_SHOTS_EXAMPLES = [
    ("Im sad", "its seems you're unhappy now"),
    ("I disappointed my girlfriend cause I didn't bring her flowers on valentine's day",
    "I understand that you think you hurtt someone you love"),
...
REFLECTION_EXAMPLES_DICT_TEST = {
    "short_pos_lst_feel": ["I feel good", "I'm anxious", "hungry", "I'm angry","so confused", "feel depression", "I'm feel nervous", "busy",  "feeling ashamed", "loved"],
    "short_neg_lst_feel": ["I'm not happy", "I'm not tired", "feel not satisfied", "I'm not trained", "feel not good enough", "I don't feel interesting", "not unique", "not so bad", "I'm not frustrated", "not motivated"],
    ...
    "blend_feeling_lst": ["I'm hurt and not calm", "I'm angry and unsatisfied","Not relaxed and excited","Indifferent and unhappy","humiliated and unsecure","I feel unstable and confused", "Anxious and unsettled","I feel loved and out of control", "I'm depressed and joyless","Brave and fearless"],
    "emotions_and_their_reasons": ["I am sad because my dog was lost yesterday", "I am very excited about the party on Friday", "I’m hurt because my friends didn’t invite me to the party","I was so happy when I got the job because it means I can support my family",
